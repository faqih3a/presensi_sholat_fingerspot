...
<div class="row">
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4 p-4">
            <form action="{{ route('asatidz.update', $asatidz->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                @if($asatidz->avatar)
                                    <div>
                                        ...
                                        <img src="{{ asset('storage/avatars/' . $asatidz->avatar) }}" alt="Avatar" class="rounded-3 border object-fit-cover" style="width: 100px; height: 100px;">
                                    </div>
                                @endif
